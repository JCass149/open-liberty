 ...
 *******************************************************************************/
package com.ibm.ws.microprofile.config20.converters;
 ...
 *
 */
public class Config20ImplicitConverter extends BuiltInConverter {

    private static final TraceComponent tc = Tr.register(Config20ImplicitConverter.class);
     ...
     */
    public Config20ImplicitConverter(Class<?> converterType) {
        super(converterType);
